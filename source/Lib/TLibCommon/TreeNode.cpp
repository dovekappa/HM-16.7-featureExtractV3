...
void CTreeNode::traverse(floatv sample, double inCoef, double& lOutCoef, double& rOutCoef, DATA_SET dset)
{
	double value = pData->getSingleValue(sample, splitting.divAttr);  //value of the split attribute
